...
public class HistoryReceiptActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pTvHistoryReceipt = (TextView) findViewById(R.id.tvHistoryReceipt);

        historialRecepcion();

    }

    public void historialRecepcion() {

        String userId = mAuth.getCurrentUser().getUid();
        dbProd = FirebaseDatabase.getInstance().getReference("ReceivedProductHistory");
...
//                    limpiarCampos();
                    Toast toastProduct = Toast.makeText(HistoryReceiptActivity.this, "No hay historial de recepcion", Toast.LENGTH_LONG);
